...
NEURO_SAN_SERVER_PORT=${NEURO_SAN_SERVER_PORT:-30015}
...
AGENT_TOOLBOX_INFO_FILE=${AGENT_TOOLBOX_INFO_FILE:-${PYTHONPATH}/toolbox/toolbox_info.hocon}
export NEURO_SAN_SERVER_HOST NEURO_SAN_SERVER_PORT
export AGENT_MANIFEST_FILE AGENT_TOOL_PATH AGENT_TOOLBOX_INFO_FILE
...
echo "AGENT_TOOLBOX_INFO_FILE=${AGENT_TOOLBOX_INFO_FILE}"
